...
if [ -d /workspace/workshop/.git ]; then
  ...
  git clone -b main https://github.com/acceleratescience/hands-on-agentic-ai.git /workspace/workshop
  echo "Repository cloned to /workspace/workshop"
fi

cd /workspace/workshop

rm -rf .github .devcontainer .dockerignore .pre-commit-config.yaml mkdocs.yml
